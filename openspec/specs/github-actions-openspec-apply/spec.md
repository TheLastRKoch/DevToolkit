# github-actions-openspec-apply Specification

## Purpose
This capability lets maintainers manually dispatch GitHub Actions to apply an OpenSpec change from a selected repository ref with a configurable AI model and publish the resulting implementation as a reviewable pull request.
